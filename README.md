...
**Import URL:**
```
https://github.com/RandyHaylor/theia-sdk-unity2022-3-lts-samples.git?path=/EyeTrackingCommon
```
...
2. Paste: `https://github.com/RandyHaylor/theia-sdk-unity2022-3-lts-samples.git?path=/EyeTrackingCommon`
3. Click "Add"
